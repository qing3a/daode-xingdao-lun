...
<body>
    ...
    <header class="hero">
        ...
        <h1>青山</h1>
        <p class="subtitle">以系统与生存的语言，重读经典</p>
    ...
    <main>
            ...
            <div class="work-grid">
                <div class="work-card">
                    ...
                    <div class="work-actions">
                        <a class="btn btn-primary" href="./行道论.html">书页详情</a>
                        <a class="btn btn-ghost" href="./道德经.html">在线阅读</a>
                    </div>
                </div>
        ...
        <section id="about">
            ...
            <div class="about-text">
                <p>青山，以系统与生存的视角重读经典的作者。作品以统一的概念系统贯穿始终，注重可实践、可检验。</p>
